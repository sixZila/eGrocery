		...
		addButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if(editText.getText().toString().equals("")) {
					...
					toast = Toast.makeText(context, "Successfully added " + editText.getText().toString() + ".", Toast.LENGTH_SHORT);
					toast.show();
		...
		case R.id.deleteList:
			...
			.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					...
					assets.getlistView().remove(info.position);
					adapter.remove(title);
					toast = Toast.makeText(context, "Successfully removed " + title + ".", Toast.LENGTH_SHORT);
					toast.show();
				}
			})
